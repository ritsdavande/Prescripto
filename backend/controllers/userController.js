...
const bookAppointment = async (req, res) => {
  try {
    ...
    // checking availablity for doctor
    ...
    //savenew slots booked in doctorData
...
//API to get user appointment from frontend my-appointments page
