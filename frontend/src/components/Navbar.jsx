    ...
    return (
        <div className='flex justify-between items-center text-sm py-4 mb-5 border-b border-b-gray-200'>
            ...
            <ul className='hidden md:flex items-start gap-5 font-medium'>
                ...
                <a href="https://prescripto-admin.vercel.app" target="_blank" rel="noreferrer" className='border border-gray-400 rounded-full px-4 py-1 text-sm font-medium text-gray-600 hover:bg-gray-100 transition-colors'>
                    Admin Panel
                </a>
            </ul>
            ...
            <img onClick={()=>setMenu(true)} className='w-6 md:hidden cursor-pointer' src={assets.menu_icon} alt="" />
                ...
                <div className={`${menu ? 'fixed w-full' : 'h-0 w-0'} md:hidden right-0 top-0 bottom-0 z-20 overflow-hidden bg-white transition-all`}>
                    ...
                    <ul className='flex flex-col items-center gap-2 mt-5 px-5 text-lg font-medium'>
                        ...
                        <a href="https://prescripto-admin.vercel.app" target="_blank" rel="noreferrer" onClick={()=>setMenu(false)}>
